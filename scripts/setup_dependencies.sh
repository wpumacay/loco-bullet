...
# bullet3 physics library (from master, testing latest changes)
echo "==> Cloning bulletphysics/bullet3 @ github - master branch"
git clone https://github.com/bulletphysics/bullet3.git ext/bullet3
