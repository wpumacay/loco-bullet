...
PREFIX = 'wp_loco_bullet_%s_' % ( VERSION )
...
setup(
    name                    = 'wp-loco-bullet',
    version                 = VERSION,
    description             = 'Bullet-backend support for Loco(locomotion framework)',
    author                  = 'Wilbert Santos Pumacay Huallpa',
    license                 = 'MIT License',
    author_email            = 'wpumacay@gmail.com',
    url                     = 'https://github.com/wpumacay/tysocBullet',
    keywords                = 'locomotion control simulation Bullet',
    zip_safe                = False,
