...
TEST( TestLocoRuntimeBulletBackend, TestRuntimeBulletBackend )
{
    loco::InitUtils();
    ...
    auto runtime = std::make_unique<loco::TRuntime>( loco::config::physics::BULLET,
    ...
    EXPECT_EQ( simulationRef->backendId(), "BULLET" );
