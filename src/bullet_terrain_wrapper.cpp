...
//     TBtTerrainGenWrapper::TBtTerrainGenWrapper( TITerrainGenerator* terrainGenPtr, 
...
//                                ( _btPrimitivePtr->tysocPrimitiveObj->type == TERRAIN_TYPE_STATIC ) );
...
//             if ( m_btTerrainPrimitives[i]->tysocPrimitiveObj->type == TERRAIN_TYPE_STATIC )
//                 return;
...
//     void TBtTerrainGenWrapper::_wrapReusablePrimitive( TTerrainPrimitive* primitivePtr )
//     {
...
//     void TBtTerrainGenWrapper::_wrapStaticPrimitive( TTerrainPrimitive* primitivePtr )
//     {
//         auto _btPrimitive = new TBtTerrainPrimitive();
