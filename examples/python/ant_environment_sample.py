...
_agent = tysoc_bindings.PyCoreAgent( 'agent0', [1,1,1.25], 'mjcf', 'walker' )
...
while _visualizer.isActive() :
    ...
    ## # vectorized observations are not yer supported ...
    ## # in bullet (create the appropriate sensors instead)
